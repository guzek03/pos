...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { percentage: @tax.percentage, state: @tax.state, year: @tax.year } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { percentage: @tax.percentage, state: @tax.state, year: @tax.year } }
